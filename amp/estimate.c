...
// printf("--channel--\n");
            ...
            // gsl_matrix_complex_set_zero(z_d);
            // gsl_matrix_set_zero(zeta_d);
            ...
            // gsl_matrix_complex_set_zero(z_c);
            // gsl_matrix_set_zero(zeta_c);
